                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                ...
                                <p>
                                    Manage Super Admin <i class="right fas fa-angle-left"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">

                                <li class="nav-item">
                                    <a href="{{route('superadmin.addSuper')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Super Admin </p>
                                    </a>
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                ...
                                <p>
                                    Manage Admin <i class="right fas fa-angle-left"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link">
                                ...
                                <p>
                                    Manage Staff <i class="right fas fa-angle-left"></i>
                                </p>
                            </a>
                            <ul class="nav nav-treeview">
